...
import net.mantori.mixin.StructureFeatureAccessor;
...
public class ModStructures {
    ...
    public static void registerStructureFeatures() {
        ...
        StructureFeatureAccessor.callRegister(Mantori.MOD_ID + ":sky_structures", SKY_STRUCTURES, GenerationStep.Feature.SURFACE_STRUCTURES);
    }
}