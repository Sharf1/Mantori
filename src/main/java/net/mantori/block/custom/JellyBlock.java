...
public class JellyBlock extends Block {
	...
	public void onLandedUpon(World world, BlockState state, BlockPos pos, Entity entity, float fallDistance) {
		if (entity.bypassesLandingEffects()) {
			...
			entity.handleFallDamage(fallDistance, 0.0F, new DamageSource(
					world.getRegistryManager().get(RegistryKeys.DAMAGE_TYPE).entryOf(DamageTypes.FALL)));
			world.playSound(null, pos, SoundEvents.BLOCK_SLIME_BLOCK_FALL, SoundCategory.BLOCKS, 1.0F, 1.0F);
		}
	...
	static {
		...
		BITES_TO_SHAPE = new VoxelShape[] { Block.createCuboidShape(1.0, 0.0, 1.0, 15.0, 8.0, 15.0),
