...
public class GreaterAphidRenderer extends GeoEntityRenderer<GreaterAphidEntity> {
	public static final Map<GreaterAphidVariant, Identifier> LOCATION_BY_VARIANT = Util
			.make(Maps.newEnumMap(GreaterAphidVariant.class), (map) -> {
	...
	public Identifier getTextureLocation(GreaterAphidEntity entity) {
		if (entity.isBaby())
			return new Identifier(Mantori.MOD_ID, "textures/entity/greater_aphid/greater_child.png");
		else
			return LOCATION_BY_VARIANT.get(entity.getVariant());
	}

	@Override
	public RenderLayer getRenderType(GreaterAphidEntity animatable, Identifier texture,
			@Nullable VertexConsumerProvider bufferSource, float partialTick) {
		return super.getRenderType(animatable, texture, bufferSource, partialTick);
	}

	@Override
	public void preRender(MatrixStack stack, GreaterAphidEntity animatable, BakedGeoModel model,
			VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isRender, float partialTick,
			int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		super.preRender(stack, animatable, model, bufferSource, buffer, isRender, partialTick, packedLight, packedOverlay, red,
				green, blue, alpha);
	...
	@Override
	public void render(GreaterAphidEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
