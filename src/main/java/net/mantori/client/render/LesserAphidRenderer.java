...
public class LesserAphidRenderer extends GeoEntityRenderer<LesserAphidEntity> {
	public static final Map<LesserAphidVariant, Identifier> LOCATION_BY_VARIANT = Util
			.make(Maps.newEnumMap(LesserAphidVariant.class), (map) -> {
	...
	public Identifier getTextureLocation(LesserAphidEntity entity) {
		if (entity.isBaby())
			return new Identifier(Mantori.MOD_ID, "textures/entity/lesser_aphid/lesser_child.png");
		else
			return LOCATION_BY_VARIANT.get(entity.getVariant());
	}

	@Override
	public RenderLayer getRenderType(LesserAphidEntity animatable, Identifier texture,
			@Nullable VertexConsumerProvider bufferSource, float partialTick) {
		return super.getRenderType(animatable, texture, bufferSource, partialTick);
	}

	@Override
	public void preRender(MatrixStack stack, LesserAphidEntity animatable, BakedGeoModel model,
			VertexConsumerProvider bufferSource, VertexConsumer buffer, boolean isRender, float partialTick,
			int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
		super.preRender(stack, animatable, model, bufferSource, buffer, isRender, partialTick, packedLight,
	...
	@Override
	public void render(LesserAphidEntity entity, float entityYaw, float partialTicks, MatrixStack stack,
